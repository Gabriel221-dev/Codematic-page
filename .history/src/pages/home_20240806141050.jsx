        ...
        <content>
          ...
          <div className="heading-sub-1">
            ...
            <div className="sub-heading-1">
              we are training 1,000,000 african youths in cloud technology , AI,
              and Open source by 2034 , unlocking global opportunities and
      ...
      <section className="Home-7">
        <container>
          <content>
            ...
            <div className="action">
              <a href="" alt="" className="apply-heading icon-71 ">
                <TbSunset2 />
                Learn More
              </a>
              <a href="" alt="" className="learn-heading icon-72">
                Apply Now
                <em className="icon-72-1">
                  <IoMdArrowForward />
                </em>
              </a>
            </div>

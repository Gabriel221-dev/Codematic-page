    ...
    <div className="Home">
              ...
              <div className="heading-sub-5">
                <article>
                  <div>
                    ...
                    <div>
                      <p>
                        Yinka is a senior business and technology leader,
                        formerly at Google and Goldman Sachs.
                      </p>
                      <p>
                        Yinka co-founded the Codematic Group to bridge the
                        technology gap in Africa, and transform how
                        organisations operate. He has an unwavering belief in
                        Africa’s potential and envisions its youth as the most
                        sought-after tech talents globally.
                      </p>
                    </div>
                  </div>
                </article>
      ...
      <section className="Home-6">
        <container>
          <content>
            ...
            <div>Meet some of our recent talents</div>
            <div>
      ...
      <section className="Home-7">
        <container>
          <content>
            <div>
              <div>We’re calling on amazing talent!</div>
              <div>

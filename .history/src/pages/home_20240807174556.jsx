...
function home() {
  return (
    <div className="Home">
      ...
      <nav className="Home-2">
        <container className="leg">
      ...
      <nav className="Home-7">
        <container>
          <content>
            ...
            <div className="action">
              <a href="" alt="" className="learn-heading icon-71 ">
                Learn More
                <i>
                  <TbSunset2 />
                </i>
              </a>
              <a href="" alt="" className="apply-heading icon-72">
                Apply Now
                <i>
                  <IoMdArrowForward />
                </i>

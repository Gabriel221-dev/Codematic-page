          ...
          <content>
            <div className="heading-sub-2">
              ...
              <article className="text-2">
                ...
                <br></br> Our operations in Nigeria revealed a large skill gap
                between African youths and their counterparts in developed
                markets in Europe and the US. This severely limits economic
                growth and access to job opportunities, which are already scarce
                in Africa. Therefore, we created the Codematic Academy as a
                non-profit arm of Codematic Group. Through the Academy, we
                resolved to bridge the skill and opportunity gap, while
